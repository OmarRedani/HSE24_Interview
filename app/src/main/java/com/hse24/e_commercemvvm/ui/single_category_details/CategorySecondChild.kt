...
import com.hse24.e_commercemvvm.ui.MainActivity
...
class CategorySecondChild : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val categoryAdapter = CategoryAdapterSecondChild(CategoryFirstChild.dataCategoryFirst.children[position].children)
